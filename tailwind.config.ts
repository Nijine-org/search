  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        '56': '56px',
        '64': '64px',
        sectionHeader: ['clamp(2rem, 3.125vw, 3.125rem)', { lineHeight: '1.2' }], // 50px, Line-height 1.2
        sectionPara: ['clamp(1.5rem, 3.125vw, 1.875rem)', { lineHeight: '1.5' }], // 30px
        fontPara: ['clamp(1.5rem, 3.125vw, 1.5rem)', { lineHeight: '1.4' }], // 24px
        helpPara: ['clamp(1rem, 3.125vw, 1.25rem)', { lineHeight: '1.6' }], // 20px
        worksPara: ['clamp(1rem, 3.125vw, 1.125rem)', { lineHeight: '1.6' }], // 18px
        footerPara: ['clamp(1rem, 3.125vw, 1rem)', { lineHeight: '1.4' }], // 16px
        pricePara: ['clamp(0.875rem, 3.125vw, 0.9375rem)', { lineHeight: '1.3' }], // 15px
        scrollPara: ['clamp(0.875rem, 3.125vw, 0.875rem)', { lineHeight: '1.3' }], // 14px
      },
      padding: {
        '30': '30px',
      },
