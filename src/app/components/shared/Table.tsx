...
const Table = <T extends object>({
  ...
  const [query, setQuery] = useUpdateQuery({ limit: '20' });
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between sm:flex-row flex-col gap-6   mb-4">
          <div className="flex items-center gap-5">
            <div className="flex items-center justify-center  sm:mt-0 mt-3">
            ...
            {total && (
              <div className="flex items-center justify-center  sm:mt-0 mt-3">
                <p className="mr-2 ">Total Records : </p>
                <p>{total}</p>
              </div>
            )}
          </div>
