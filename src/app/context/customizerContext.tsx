...
interface CustomizerContextState {
  ...
  payRunEmpActiveTab: string;
  setIspayRunEmpActiveTab: (active: string) => void;
...
export const CustomizerContextProvider: React.FC<CustomizerContextProps> = ({
  ...
  const [payRunEmpActiveTab, setIspayRunEmpActiveTab] = useState(
    config.empOverviewTab,
  );
